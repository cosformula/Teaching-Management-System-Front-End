  ...
  <div @keyup.enter="onSubmit">
    <el-form :inline="true" size="mini" ref="form" :model="form" label-width="55px">
      <el-form-item label="课程号">
        <el-input v-model.trim.lazy="form.courseID"></el-input>
      </el-form-item>
      <el-form-item label="课程名">
        <el-input v-model.trim.lazy="form.courseName"></el-input>
      </el-form-item>
      <el-form-item label="教师名">
        <el-input v-model.trim.lazy="form.teacherName"></el-input>
      </el-form-item>
      <el-form-item label="学分">
        <el-input v-model.trim.lazy="form.credit"></el-input>
      </el-form-item>
      <el-form-item label="时间">
        <el-input placeholder="格式：一1-2" v-model.trim.lazy="form.time"></el-input>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="tableData" highlight-current-row border height="400">
      ...
      <el-table-column label="教师" width="80">
        <template slot-scope="scope">
          <span style="white-space:nowrap;" v-if="scope.row.teacher"> {{ scope.row.teacher.name }}</span>
        </template>
      </el-table-column>
      <!-- <el-table-column label="教师" width="80" v-else>
        <template slot-scope="scope">
          <span style="white-space:nowrap;"> {{ scope.row.teacher_raw }}</span>
        </template>
      </el-table-column> -->
      <!-- <el-table-column prop="teacher.name" label="课程号" width="100">
      </el-table-column> -->
...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      this.$http
        .get(
          '/api/classes/?term=2018_1&type=advance&courseID=' +
            this.form.courseID +
            '&courseName=' +
